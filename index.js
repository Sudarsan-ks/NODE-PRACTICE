...
app.get('/product', async(req,res)=>{
    ...
    try{
        ...
        const filterProduct = await client.db("MongoDBpractice").collection("products").find(sud).toArray()
...
app.get('/product/:id', async(req, res)=>{
    const { id } = req.params
    const Product = await client.db("MongoDBpractice").collection("products").findOne({id:id})
    res.send(Product)
})
...
app.post('/product', async(req, res)=>{
    ...
    const result = await client.db("MongoDBpractice").collection("products").insertMany(newproduct)
    res.send(result)
})
